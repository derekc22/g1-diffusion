...
Usage:
    python sample_stage1_fm.py --config_path ./experiments/stage1/sample_stage1_fm.yaml
"""
...
def main():
    ...
    parser.add_argument("--config_path", type=str,
                        default=os.path.join(PROJECT_ROOT, "experiments", "stage1", "sample_stage1_fm.yaml"),
    ...
    if "logs" in ckpt_parts and "checkpoints" in ckpt_parts:
        ...
        sample_folder = f"fm_{solver}{num_steps}_{timestamp}{suffix}"
