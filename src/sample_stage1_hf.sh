...
# Run all Stage 1 HF experiment configs in experiments/stage1_hf/
# Usage: ./src/sample_stage1_hf.sh

# Initialize conda for this non-interactive shell
source /home/learning/miniconda3/etc/profile.d/conda.sh

EXPERIMENTS_DIR="/home/learning/Documents/g1-diffusion/experiments/stage1_hf"
...
for config_path in "${configs[@]}"; do
    ...
    python scripts/sample_stage1_hf.py --config_path "$config_path"
...
echo "All Stage 1 HF experiments completed!"
