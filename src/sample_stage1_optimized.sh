...
# Run all Stage 1 Optimized experiment configs in experiments/stage1_optimized/
# Usage: ./src/sample_stage1_optimized_all.sh

# Initialize conda for this non-interactive shell
source /home/learning/miniconda3/etc/profile.d/conda.sh

EXPERIMENTS_DIR="/home/learning/Documents/g1-diffusion/experiments/stage1_optimized"
...
for config_path in "${configs[@]}"; do
    ...
    python scripts/sample_stage1_optimized.py --config_path "$config_path"
...
echo "All Stage 1 Optimized experiments completed!"
