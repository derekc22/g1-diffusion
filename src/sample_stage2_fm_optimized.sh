...
# Run all Stage 2 FM Optimized experiment configs in experiments/stage2_fm_optimized/
# Usage: ./src/sample_stage2_fm_optimized.sh

# Initialize conda for this non-interactive shell
source /home/learning/miniconda3/etc/profile.d/conda.sh

EXPERIMENTS_DIR="/home/learning/Documents/g1-diffusion/experiments/stage2_fm_optimized"
...
for config_path in "${configs[@]}"; do
    ...
    python scripts/sample_stage2_fm_optimized.py --config_path "$config_path"
...
echo "All Stage 2 FM Optimized experiments completed!"
