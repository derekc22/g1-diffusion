...
# Dynamic-object visualization for regular OMOMO/BPS model samples.
...
# Optional: set only if you have a matching source/reference PKL folder.
REFERENCE_MOTION_FOLDER=""
...
echo "All OMOMO dynamic videos completed."
