...
# Run all Stage 2 experiment configs in experiments/stage2/
# Usage: ./src/sample_stage2_all.sh

# Initialize conda for this non-interactive shell
source /home/learning/miniconda3/etc/profile.d/conda.sh

EXPERIMENTS_DIR="/home/learning/Documents/g1-diffusion/experiments/stage2"
...
for config_path in "${configs[@]}"; do
    ...
    python scripts/sample_stage2.py --config_path "$config_path"
