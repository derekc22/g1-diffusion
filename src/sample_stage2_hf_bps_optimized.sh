...
# Run all Stage 2 HF-BPS optimized experiment configs in experiments/stage2_hf_bps_optimized/
source /home/learning/miniconda3/etc/profile.d/conda.sh

EXPERIMENTS_DIR="/home/learning/Documents/g1-diffusion/experiments/stage2_hf_bps_optimized"
...
echo "All Stage 2 HF-BPS optimized experiments completed!"
