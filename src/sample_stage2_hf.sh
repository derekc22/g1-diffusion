...
# Run all Stage 2 HF experiment configs in experiments/stage2_hf/
# Usage: ./src/sample_stage2_hf.sh

# Initialize conda for this non-interactive shell
source /home/learning/miniconda3/etc/profile.d/conda.sh

EXPERIMENTS_DIR="/home/learning/Documents/g1-diffusion/experiments/stage2_hf"
...
for config_path in "${configs[@]}"; do
    ...
    python scripts/sample_stage2_hf.py --config_path "$config_path"
...
echo "All Stage 2 HF experiments completed!"
